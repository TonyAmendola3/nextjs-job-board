...
ALTER TABLE "user-resume" ADD CONSTRAINT "user-resume_userId_users_id_fk" FOREIGN KEY ("userId") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
